...
function LoadingPage() {
  ...
  if(loading) return (
    <div className='fixed flex bg-[#181818] justify-center items-center w-full top-0 left-0 right-0 bottom-0 z-[9999999999999]'>
      <svg version="1.1"
